...
Complete technical documentation for Keystone. The [README](../README.md) is the overview; this is the full reference for every subsystem.
...
Each student builds a Keystone Document: a personal, source-grounded body of knowledge organized into the four levels of Depth of Knowledge (DOK): verifiable facts, their own synthesis, cross-source insight, and a defensible point of view on questions where even experts disagree. Along the way, the platform surfaces relevant sources through multi-agent research, verifies facts against evidence, and grades synthesis quality. It coaches through questions and never hands over answers, taking the student from raw curiosity to earned expertise.
...
7. **Defend it.** With Adversary Defense, the student defends that position against an escalating AI opponent across 12 rounds — the final proof of ownership.
